...
from denariium.keystore import bip39_normalize_passphrase
from denariium.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the Denarius in the wallet.") % self.device
        else:
...
class TrezorClientBase(GuiMixin, PrintError):
    ...
    #    return self.get_address('Denarius', self.expand_path(derivation))
