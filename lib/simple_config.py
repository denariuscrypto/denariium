...
SYSTEM_CONFIG_PATH = "/etc/denariium.conf"
...
def read_system_config(path=SYSTEM_CONFIG_PATH):
    """Parse and return the system config settings in /etc/denariium.conf."""
    result = {}
    if os.path.exists(path):
        try:
            import ConfigParser
        except ImportError:
            print "cannot parse denariium.conf. please install ConfigParser"
            return
