import select, time, denariium as electrum, Queue
from denariium import Connection, Interface, SimpleConfig
from denariium.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    server = 'denariium.bysh.me:50002:s'
